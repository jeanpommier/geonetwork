...
Geographic data are often producted by organizations or freelances and may match to different use cases (GIS operators, image analysis, politics, ...). A proper documentation about those data helps better understand the data, and make proper use for production, use and update.
