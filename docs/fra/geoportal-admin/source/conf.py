...
project = u'Géoportail pour la Gestion des Risques'
...
latex_documents = [
  ('index', 'RiskManagementGeoportal-EditorManual.tex', u'Géoportail pour la Gestion des Risques, Manuel Editeurs et Administrateurs',
