...

	{
		...
		,children   : [
			/*{
		        ...
		        ,layer       : "Surfaces en eau (Inwatr_p - FAO)"
					...
					/*{
						...
						,type		: 'wms'
                                               ...
                                               ,tablenames     : ['v_7d2_globcover_reg','v_7d2_globcover_cer','v_7d2_globcover_com']
                                                ,changeScales: [5000000,500000,0]
                                                ,charting_fields: ["value_11","value_14","value_20","value_30","value_40","value_60","value_110","value_120","value_130","value_140","value_150","value_180","value_190","value_200","value_210","surface"]
                                                ,other_fields: [] // [ "codecercle", "nomcercle" ]
//**************************************************************************************************************                        
 						,context 	: {  //optional field, overrides the default one
							            getSize: function(feature) {     // on definit ici la taille des camemberts
							                ...
							                var masize = 15 + parseInt(valtot/1000000);
